...
<script>
	...
	function show4(selbox,inbox){
		var data= selbox.value;//document.fm.sel1 ||sel2. value;
		// alert(data);
		inbox.value=data; // document.fm.sel1c
	}
</script>
</head>
<body>
	...
	<form name="fm">  <!-- 🔥 form 태그의 속성='fm' → name="fm" 수정 -->
		...
		<select name="sel1" onchange="show4(this,document.fm.sel1c)">
		...
		<select name="sel2" onchange="show4(this,document.fm.sel2c)"> <!-- 🔥 name ='sel2' → name="sel2" 수정 -->
